...
RotarySignalPerSec = downsample(RotarySignalPerSec,15);%RUNNING
tmptime = downsample(Actualtime,15);  %TIMELINE
...
if fancymethod % Fancy one but takes forever
    ...
    %Take window
    windowaroundframe = [0.1 0.5];%0 to 0.5 seconds surrounding frame on
